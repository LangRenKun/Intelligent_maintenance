...
class DeviceApi:
    ...
    def send_heart(self):
        ...
        #caowei test
        topic = "v1/devices/me/"+self.device.sn+"/attributes"
...
class Mqtt:
    def __init__(self,device_api):
        ...
        self.port = 13173
        '''
        #曹炜caowei@micang.com：caolaoban
        self.user = "caoweitestC3"
        self.passwd = ""
        self.host = "182.254.135.92"
        self.port = 1883
